        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-head" style="background: #253544; gradient(left, #1c65a9 0%, #5a5c5c 100%) !important; border-radius: 10px;">
                    <div class="ibox-title" style="color: #ffffff;"><h1>Home Slider Lists</h1></div>
                    <a href="{{route('slider.create')}}" class="btn btn-success add-btn">
                        <i class="fa fa-plus">Add Slider</i>
                    </a>
                </div>
            </div>
            <div class="ibox-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($sliderDetail->enabled == 1)
                                        Show On Front <a href="{{url('witn/disable', $sliderDetail->id)}}" class="btn btn-danger btn-xs">Hide From Front</a>
                                    @else
                                        Hide From Front <a href="{{url('witn/enable', $sliderDetail->id)}}" class="btn btn-success btn-xs"> Show On Front</a>
                                    @endif
