...
@section('title','Edit Testimonal Page | WITN')
@section('styles')
...
@section('main-content')
    @if(isset($testimonalDetail))
        {{Form::open(['url'=>route('testimonal.update',$testimonalDetail->id), 'files'=>true, 'class'=>'form'])}}
        @method('patch')
    @endif
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-body">
                    ...
                    <div class="form-group row">
                        ...
                        @if(isset($testimonalDetail))
                            <div class="col-md-4">
                                <img src="{{asset('uploads/testimonal/'.$testimonalDetail->image)}}" alt="" class="img img-responsive img-thumbnail" width="100px;">
                            </div>
                        @endif
                    </div>
                    <div class="form-group row">
