...
@section('title','Edit SLider Page | WITN')
@section('styles')
        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-head" style="background: #253544; gradient(left, #1c65a9 0%, #5a5c5c 100%) !important; border-radius: 10px;" >
                    <div class="ibox-title" style="color: #ffffff;"><h1>{{isset($sliderDetail) ? 'Update' : 'Add'}} Home SLider</h1></div>
                ...
                <div class="ibox-body">
                    ...
                    <div class="form-group row">
                        ...
                        @if(isset($sliderDetail))
                            <div class="col-md-4">
                                <img src="{{asset('uploads/slider/'.$sliderDetail->logo_image)}}" alt="" class="img img-responsive img-thumbnail" width="100px;">
                            </div>
                        @endif
                    </div>
                    <div class="form-group row">
