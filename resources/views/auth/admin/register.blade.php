...
<div class="limiter">
    <div class="container-login100" style="background-image: url('{{asset('css/admin/images/bg-01.jpg')}}');">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            ...
            <form class="login100-form validate-form" action="{{ route('admin.register.post') }}" method="post">
                @csrf
                <div class="wrap-input100 validate-input m-b-23" data-validate = "UserName is required">
                    <span class="label-input100">UserName</span>
                    <input class="input100" type="text" name="name" placeholder="UserName" value="{{ old('name') }}" required autocomplete="name" autofocus>
